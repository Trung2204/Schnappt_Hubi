            	...
            	Platform.runLater(() -> {
                    ...
                    switch (model.getCurrentState()) {
                        ...
                        case PERFORM_PLAYER_ACTION:
                            // Get the current player's chosen action and direction
                            ActionType action = model.getListOfPlayers()[model.getCurrentPlayerIndex()].chooseAction(model.isGhostActivated(), model.isMagicDoorFound());
                            DirectionType direction = model.getListOfPlayers()[model.getCurrentPlayerIndex()].chooseDirection();
                            model.performPlayerAction(action, direction);
                            break;
                        case REMOVE_PAIRS:
...
//    private static void findAdjacentPairs() {
...
//        }
//    }
//    private static void removePairs(int x, int y) {
