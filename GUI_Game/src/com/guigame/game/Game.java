...
//        returnButton.setVisible(playerIndex != 0); // Don't show for the first player
        ...
        submitCharacterAndPositionButton.setOnAction(characterAndPositionEvent -> {
            ...
            CharacterType character = CharacterType.valueOf(characterInput);
            ...
            if (character == CharacterType.RABBIT) numberOfRabbits++;
            else if (character == CharacterType.MOUSE) numberOfMice++;
        ...
        returnButton.setOnAction(returnEvent -> {
            ...
            if (playerIndex > 0 && listOfPlayers[playerIndex - 1] != null) {
                ...
                if (previousPlayer.getCharacter() == CharacterType.RABBIT) {
                    numberOfRabbits--;
                } else if (previousPlayer.getCharacter() == CharacterType.MOUSE) {
                    numberOfMice--;
                }
